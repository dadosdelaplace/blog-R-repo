...
<mark>**Palabras más repetidas en CREA (las 15 000 primeras)**</mark>
...
idx_frec <-
  which(CREA_puntuado$palabras_puntuadas$frec_norm > 50 &
          CREA_puntuado$palabras_puntuadas$nletras == 5)
datos_CREA_frecuentes <- CREA_puntuado
datos_CREA_frecuentes$palabras_puntuadas <-
  datos_CREA_frecuentes$palabras_puntuadas[idx_frec, ]
datos_CREA_frecuentes$matriz_letras <-
  datos_CREA_frecuentes$matriz_letras[, idx_frec]
